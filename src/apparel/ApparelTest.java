...
public class ApparelTest extends BaseTest {
    ...
    public void verifyOpenBrowserAndLogIn() throws InterruptedException {
        ...
        Thread.sleep(2000);
        sendTextToElement(By.id("FirstName"),"Sophie");   //firstname
        sendTextToElement(By.id("LastName"),"clark");   //lastname
        sendTextToElement(By.id("Email"),"sclark60@gmail.com"); //email id has to be changed before running
    ...
    public void verifyThatTheProductAddedSuccessfullyAndPlaceOrderSuccessfullyWithExistingUser() throws InterruptedException {
        ...
        Thread.sleep(3000);
        sendTextToElement(By.id("Email"), "sclark60@gmail.com"); //email
        sendTextToElement(By.id("Password"), "happydays");    //password
        ...
        sendTextToElement(By.id("BillingNewAddress_City"), "Malbourn");   //city
        sendTextToElement(By.id("BillingNewAddress_Address1"), "80,Weetby"); //address
        sendTextToElement(By.id("BillingNewAddress_ZipPostalCode"), "100891"); //zip code
        sendTextToElement(By.id("BillingNewAddress_PhoneNumber"), "5678942"); //phone number
        ...
        sendTextToElement(By.id("CardholderName"), "Mrs.S clark");  //name on card
        ...
        sendTextToElement(By.id("CardCode"), "9004");            //cvc cardcode
